...
export default function ClientDashboard() {
  ...
  const cancelAppointmentMutation = useMutation({
    ...
    onSuccess: (data: any) => {
      ...
      toast({
        title: "Agenda de Belezamento cancelado",
        description: message,
  ...
  const rescheduleAppointmentMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/client/appointments"] });
      toast({
        title: "Agenda de Belezamento reagendado",
  ...
  const getStatusBadge = (status: string) => {
    const statusConfig = {
      ...
      scheduled: { label: "Agenda de Belezado", variant: "default" as const },
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/5 to-accent/10 p-4">
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-foreground">Meus Agenda de Belezamentos</h1>
          ...
          <div className="flex items-center space-x-3">
            ...
            >
              ...
              <span>Novo Agenda de Belezamento</span>
            </Button>
            <Button
            ...
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Próximos Agenda de Belezamentos</p>
                </div>
              </div>
            </CardContent>
          </Card>
                  ...
                  <Card key={merchant.id} className="border border-border hover:shadow-md transition-shadow" data-testid={`card-merchant-${merchant.id}`}>
                    <CardContent className="p-4">
                      <div className="space-y-3">
                        ...
                        >
                          {merchant.isOpen ? "Agenda de Belezar Serviço" : "Salão Fechado"}
                        </Button>
                      </div>
                    </CardContent>
                  </Card>
                        ...
                        {relatedAppointment && (
                          <div className="mt-3 p-3 bg-gray-100 dark:bg-gray-800 rounded border-l-4 border-blue-400">
                            <h5 className="font-medium text-gray-800 dark:text-gray-200 mb-2 flex items-center gap-2">
                              <CalendarIcon className="w-4 h-4" />
                              Informações do Agenda de Belezamento Cancelado
                            </h5>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                Próximos Agenda de Belezamentos
              </CardTitle>
              <CardDescription>
                ...
                {availableServices.map((service) => (
                  <div key={service.id} className="border rounded-lg p-4 hover:shadow-md transition-shadow">
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        <CalendarIcon className="w-4 h-4" />
                        Agenda de Belezar Este Serviço
                      </Button>
                    </div>
                  </div>
                ))}
          ...
          <DialogContent className="sm:max-w-[500px]">
            <DialogHeader>
              <DialogTitle className="flex items-center gap-2">
                ...
                Reagendar Agenda de Belezamento
              </DialogTitle>
              <DialogDescription>
