...
export default function ClientBooking() {
  ...
  const createAppointmentMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        title: "Sucesso!",
        description: "Agenda de Belezamento criado com sucesso",
      });
    },
    onError: (error: any) => {
      toast({
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-3xl font-bold text-foreground">Novo Agenda de Belezamento</h1>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2">
            <Card>
              <CardHeader>
                <CardTitle>Agenda de Belezar Serviço</CardTitle>
                <CardDescription>
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex justify-end space-x-4">
                    ...
                    >
                      {createAppointmentMutation.isPending ? "Agenda de Belezando..." : "Confirmar Agenda de Belezamento"}
                    </Button>
                  </div>
                </form>
              </CardContent>
                ...
                {merchantData?.[0] && !merchantData[0].isOpen && (
                  <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded">
                    ...
                    <p className="text-yellow-700 text-xs mt-1">
                      O salão está temporariamente fechado. Agenda de Belezamentos só podem ser feitos para os próximos dias.
                    </p>
                  </div>
                )}
              </CardContent>
