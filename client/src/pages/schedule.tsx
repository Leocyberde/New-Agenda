...
export default function Schedule() {
  ...
  const getStatusBadge = (status: string) => {
    const statusConfig = {
      ...
      scheduled: { label: "Agenda de Belezado", variant: "secondary" as const },
        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-2xl font-bold text-foreground">Agenda de Beleza</h1>
            </div>
            <div className="flex items-center space-x-4">
              <Button
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Select value={statusFilter} onValueChange={setStatusFilter}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="scheduled">Agenda de Belezado</SelectItem>
              ...
              <Card>
                <CardContent className="p-6 text-center">
                  ...
                  <Button
                    ...
                    className="mt-4"
                  >
                    Criar Novo Agenda de Belezamento
                  </Button>
                </CardContent>
              </Card>
            ) : (
