        ...
        <div className="px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <h1 className="text-2xl font-bold text-foreground">Novo Agenda de Belezamento</h1>
            </div>
          ...
          <Card>
            <CardContent className="p-6">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="appointmentDate">Data do Agenda de Belezamento *</Label>
                    <div className="relative">
                ...
                <div className="flex justify-end space-x-4">
                  ...
                  >
                    {createAppointmentMutation.isPending ? "Criando..." : "Criar Agenda de Belezamento"}
                  </Button>
                </div>
              </form>
            </CardContent>
